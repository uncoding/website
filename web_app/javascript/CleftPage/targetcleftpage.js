...
function nGetCleftPage(nMaxNumber,nPageNumber,nPagelocation,nStyle)
{
   if (nPageNumber==NaN || nPageNumber==undefined || nPageNumber==null || nPageNumber==0) nPageNumber=20;
   if (nMaxNumber==NaN || nMaxNumber==undefined || nMaxNumber==null || nMaxNumber==0) return "";
   if (nMaxNumber<=nPageNumber) return "<b>总计 "+nMaxNumber+" 条记录</b>";
   nowPageUrl = nPagelocation + "";
   nNewUrl = GetNoNowpageArgUrl();
   if (nPageNumber==0 || nPageNumber==null)
	  {
		 nPageNumber = 1;
	  }
...
function GetCleftPageStyle(s)
{
   ...
   style[0] = '<style type="text/css">'
	  ...
	  + '.cleft_jump			{ text-decoration: none; font: 12px Webdings; color: #006699; cursor: pointer;}'
	  + '.cleft_link			{ text-decoration: none; font: 12px; color: #006699; cursor: pointer;}'
   ...
   style[1] = '<style type="text/css">'
	  ...
	  + '.cleft_jump			{ text-decoration: none; font: 12px Webdings; color: #773300; cursor: pointer;}'
	  + '.cleft_link			{ text-decoration: none; font: 12px; color: #773300; cursor: pointer;}'
...
{
   // style = GetCleftPageStyle(nStyle)
   ...
   for (var j = nBeginPage; j <= nEndPage ; j++)
{
   if (j == nBeginPage && nBeginPage != 1)
	  {
		 nEchoString += '<td align="center" onmouseover="this.bgColor=\'#D6E0EF\'" onmouseout="this.bgColor=\'#F8F8F8\'" onclick="firstPage()" class="cleft_link">&nbsp;<b>|&lt;</b>&nbsp;</td>'
		 nEchoString += '<td align="center" onmouseover="this.bgColor=\'#D6E0EF\'" onmouseout="this.bgColor=\'#F8F8F8\'" onclick="upPage()" class="cleft_link">&nbsp;<b>&lt;</b>&nbsp;</td>'
	  }
   if (j == nNowPage)
	  {
   ...
   if (j == nEndPage && nEndPage != nMaxPage)
	  {
		 nEchoString += '<td align="center" onmouseover="this.bgColor=\'#D6E0EF\'" onmouseout="this.bgColor=\'#F8F8F8\'" onclick="downPage()" class="cleft_link">&nbsp;<b>&gt;</b>&nbsp;</td>'
		 nEchoString += '<td align="center" onmouseover="this.bgColor=\'#D6E0EF\'" onmouseout="this.bgColor=\'#F8F8F8\'" onclick="lastPage()" class="cleft_link">&nbsp;<b>&gt;|</b>&nbsp;</td>'
	  }
}
