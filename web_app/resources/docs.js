...
MainPanel = function(){
    ...
    MainPanel.superclass.constructor.call(this, {
        ...
        items: {
            id:'welcome-panel',
            title: 'HOME',
            autoLoad: {url: '/b2wms.php?act=manage.welcome', callback: this.initSearch, scope: this},
            iconCls:'icon-docs',
            autoScroll: true
...
Ext.extend(MainPanel, Ext.TabPanel, {
    ...
    loadClass : function(href, cls, member){
    	if(href=='b2wms.php?act=manage.nologin')
    	{
    		top.location.href='b2wms.php?act=manage.nologin';
    	}
        var id = 'docs-' + cls;
...
Ext.onReady(function(){
    ...
    api.expandPath('/root/gdss/basedata');
