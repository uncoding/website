...
class SimpleMail extends PHPMailer
{
  var $From     = 'report@bbctop.com';
  var $FromName = 'bbctop&team';
  var $Host     = 'mail.bbctop.com';
  var $Mailer   = 'smtp';
  var $SMTPAuth = true;
  var $CharSet  = 'UTF-8';
  var $Username = 'report@bbctop.com';
  var $Password = 'Rpt$68n(^.^)2Ol3';
  var $WordWrap = 75;
