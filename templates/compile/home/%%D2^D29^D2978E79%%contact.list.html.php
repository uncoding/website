<?php /* Smarty version 2.6.14, created on 2015-06-19 02:45:48
         compiled from default/contact.list.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div  class="single">
      <div class="ChannelContent"><!--引用百度地图API-->
            ...
            <!--地图开始-->
                ...
                <div style="width:99%;height:300px;border:#ccc solid 1px; margin:0px auto;" id="dituContent"></div>
    ...
    '; ?>
     ...
     <script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>
        ...
        function createMap(){
            ...
            var point = new BMap.Point(116.478895,39.91577);//定义一个中心点坐标
        ...
        //标注点数组
        var markerArr = [{title:"北京某某有限公司",content:"北京市朝阳区某某路某某号院某某号楼000室",point:"116.478792|39.915929",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
             ];
        //创建marker
        function addMarker(){
