<?php /* Smarty version 2.6.14, created on 2015-06-22 23:18:43
         compiled from default/casese.info.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'default/casese.info.html', 20, false),)), $this); ?>
<!DOCTYPE html>
<html>
...
<div class="article">
  <ul class="wxlist">
    <li>
      ...
      <div class="InfoPicture"><img src="/html/upload/<?php echo $this->_tpl_vars['cout']['vinfo']['img_up']; ?>
          ...
          <table border="0px" cellpadding="0px" cellspacing="3px" class="comment_table">
            <tr>
              ...
              <td class="t2"><input id="gname" name="gname" type="text" value=""  maxlength="100" />
                <input id="ctitle" name="ctitle" value="<?php echo $this->_tpl_vars['cout']['casese_catatitle']; ?>
