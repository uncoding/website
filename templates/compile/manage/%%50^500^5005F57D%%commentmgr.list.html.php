<?php /* Smarty version 2.6.14, created on 2015-06-17 22:15:55
         compiled from commentmgr.list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'commentmgr.list.html', 56, false),)), $this); ?>

<!--显示列表样式1 start-->
  <div class="pageHeader">
     <form onsubmit="return navTabSearch(this);" id="pagerForm" action="/b2wms.php?act=commentmgr.comment" method="post">
...
" />
     ...
     <div class="searchBar" >
        <table class="searchContent" >
          <tr>
          <td><label>评论名称：</label><input type="text" name="shw_title" class="required textInput" value="<?php echo $this->_tpl_vars['cout']['shw_title']; ?>
"/></td>
          <td><label>分类</label>
          <select name="cid" class="combox">
          <?php $_from = $this->_tpl_vars['cout']['comment_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<div class="pageContent" id="pagecontent">
     <div class="panelBar">
          <ul class="toolBar">
               <li><a class="add" href="/b2wms.php?act=commentmgr.commentadd&acttype=0" target="dialog" mask="true"  width="800" height="480"><span>新增</span></a></li>
          </ul>
     </div>
     <div id="w_list_print">
...
<tr target="sid_user" >
<td><?php echo ((is_array($_tmp=$this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_cid'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, '') : smarty_modifier_truncate($_tmp, 40, '')); ?>
</td>
<td><?php echo ((is_array($_tmp=$this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_lid'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, '') : smarty_modifier_truncate($_tmp, 40, '')); ?>
</td>
...
<td width="100">
<a target="dialog" mask="true" href="/b2wms.php?act=commentmgr.commentadd&acttype=1&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" width="800" height="480" class="btnEdit" >修改</a>  <a warn="请选择内容项" title="你确定要删除吗？" target="ajaxTodo" href="/b2wms.php?act=commentmgr.commentdel&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnDel"><span>删除</span></a><a target="_blank" href="/index.php?act=comment.info&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnLook" >预览</a>
</td>              
</tr>
<?php endfor; endif; ?>
