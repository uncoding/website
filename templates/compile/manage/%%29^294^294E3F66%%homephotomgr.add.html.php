<?php /* Smarty version 2.6.14, created on 2015-06-18 07:29:35
         compiled from homephotomgr.add.html */ ?>
<!--修改样式2 p元素自适应宽度 start-->
<div class="pageContent">
    <form method="post" action="/b2wms.php?act=homephotomgr.homephotoadd" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone)">
...
<div style="clear:both;"> <label>所属分类</label>
...
<div style="clear:both;"> <label>图片名称</label>
