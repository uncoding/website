<?php /* Smarty version 2.6.14, created on 2015-06-17 22:15:46
         compiled from servermgr.list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'servermgr.list.html', 56, false),)), $this); ?>

<!--显示列表样式1 start-->
  <div class="pageHeader">
     <form onsubmit="return navTabSearch(this);" id="pagerForm" action="/b2wms.php?act=servermgr.server" method="post">
...
<div class="pageContent" id="pagecontent">
     <div class="panelBar">
          <ul class="toolBar">
               <li><a class="add" href="/b2wms.php?act=servermgr.serveradd&acttype=0" target="dialog" mask="true"  width="800" height="480"><span>新增</span></a></li>
          </ul>
     </div>
     <div id="w_list_print">
...
<tr target="sid_user" >
<td><?php echo $this->_tpl_vars['cout']['server_category'][$this->_tpl_vars['cid']]; ?>
</td>
...
&r=<?php echo $this->_tpl_vars['cout']['server_ratio'][$this->_tpl_vars['cid']]; ?>
...
<td width="100">
<a target="dialog" mask="true" href="/b2wms.php?act=servermgr.serveradd&acttype=1&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" width="800" height="480" class="btnEdit" >修改</a>  <a warn="请选择内容项" title="你确定要删除吗？" target="ajaxTodo" href="/b2wms.php?act=servermgr.serverdel&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnDel"><span>删除</span></a><a target="_blank" href="/index.php?act=server.info&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnLook" >预览</a>
</td>              
</tr>
<?php endfor; endif; ?>
