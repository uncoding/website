<?php /* Smarty version 2.6.14, created on 2015-06-17 23:15:46
         compiled from seomgr.list.html */ ?>
...
" />
     ...
     <div class="searchBar" >
        <table class="searchContent" >
          <tr>
          <td><label>SEO文字标题：</label><input type="text" name="shw_title" class="required textInput" value="<?php echo $this->_tpl_vars['cout']['shw_title']; ?>
"/></td>
                    </tr>
        </table> 
          <div class="subBar">
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 $this->assign('mgrstatus', $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['mgr_status']); ?>
 
<tr target="sid_user" >
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_url']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_filename']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_title']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_alt']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['shw_path']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['mgr_status'][$this->_tpl_vars['mgrstatus']]; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['mgr_die']; ?>
</td>
<td><?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['log_time']; ?>
</td>
 
<td width="100">
<a target="dialog" mask="true" href="/b2wms.php?act=seomgr.seoadd&acttype=1&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" width="800" height="480" class="btnEdit" >修改</a>  <!--<a warn="请选择内容项" title="你确定要删除吗？" target="ajaxTodo" href="/b2wms.php?act=seomgr.seodel&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnDel"><span>删除</span></a>--><a target="ajaxTodo" href="/b2wms.php?act=seomgr.seohtml&id=<?php echo $this->_tpl_vars['cout']['vlist'][$this->_sections['i']['index']]['id']; ?>
" class="btnLook" >生成</a>
</td>
</tr>
<?php endfor; endif; ?>
